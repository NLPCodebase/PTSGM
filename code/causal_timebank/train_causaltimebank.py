...
from seq2seq_model_causaltimebank import Seq2SeqModel
...
data = pd.read_csv("./data/train_causal_timebank.csv", sep=',',encoding = 'UTF-8',usecols=[0,1]).values.tolist()
...
model = Seq2SeqModel(
    ...
    encoder_decoder_name="./exp/causaltimebank",
    args=model_args,
    # use_cuda=False,
)
