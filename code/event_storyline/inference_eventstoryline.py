...
from seq2seq_model_eventstoryline import Seq2SeqModel,AutoTokenizer
...
# model = BartForConditionalGeneration.from_pretrained('./exp/eventstoryline')
...
plt.show()
# plt.savefig('./figure-E.eps', format='eps', dpi=1000)
