...
data = pd.read_csv("./data/event_not_pretrain.csv", sep=',',encoding = 'UTF-8').values.tolist()
...
train_outputpath = './data/train_not_pretrain.csv'
eval_outputpath = './data/test_not_pretrain.csv'
